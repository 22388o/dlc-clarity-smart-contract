...
## Setup
For reference, a sample of this deployed contract can be found here: [DLC-Manager](https://explorer.stacks.co/txid/ST12S2DB1PKRM1BJ1G5BQS0AB0QPKHRVHWXDBJ27R.discreet-log-storage-v2-2?chain=testnet)
